        ...
        <div className="row">
          <div className="col-md-8">
            <Form onSubmit={submitHandler} className="row">
              ...
              <Form.Group className="mb-3 col-md-6" controlId="billingCity">
              ...
              <Form.Group className="mb-3 col-md-6" controlId="billingState">
              ...
              <Form.Group className="mb-3 col-md-6" controlId="billingCountry">
              ...
              <Form.Group className="mb-3 col-md-6" controlId="shippingState">
                <Form.Label>State</Form.Label>
                <Form.Select
                  value={shippingState}
